...
// needs to do arbitrary things basd on time.
type Clock interface {
	...
	// Consider making the sleep iterruptible by using 'select' on a context channel and a timer channel.
...
type WithDelayedExecution interface {
	Clock
	// AfterFunc executes f in its own goroutine afte waiting
...
// After is the same as time.AfterFunc(d, f).
...
// needs to do arbitrary things base on time.
